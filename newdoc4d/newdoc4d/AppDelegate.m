...
//    WEAK_SELF;
    ...
    if([NDCoreSession coreSession].openId.length != 0 || [NDCoreSession coreSession].nduid.length != 0){
...
- (void)setupUMShare{
    ...
    [UMSocialWechatHandler setWXAppId:@"wxb6eb5851177c3b4c" appSecret:@"64020361b8ec4c99936c0e3999a9f249" url:@"http://www.umeng.com/social"];
...
- (void)setupWechatLogin{
    ...
    [WXApi registerApp:@"wxb6eb5851177c3b4c" withDescription:@"weixin"];
}
...
- (void)setupBaiduMap{
    ...
    BOOL ret = [_mapManager start:@"GhWD88GumBOCle2otsUEBRpb"  generalDelegate:nil];
    if (!ret) {
    ...
    [ShareSDK registerApp:@"b0ffff49fe58"
          ...
          onConfiguration:^(SSDKPlatformType platformType, NSMutableDictionary *appInfo)
     {
         ...
         switch (platformType)
         {
                 ...
                 //                 break;
             case SSDKPlatformTypeWechat:
                 [appInfo SSDKSetupWeChatByAppId:@"wxb6eb5851177c3b4c"
